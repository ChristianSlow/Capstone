...
<template>
  <main class="md:ml-64 h-auto p-1 pt-16 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white text-base md:text-lg">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-7">
          ...
          <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 flex items-center space-x-4 border-t-4 border-green-500 transition-all hover:shadow-lg hover:-translate-y-1">
          ...
          <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 flex items-center space-x-4 border-t-4 border-red-500 transition-all hover:shadow-lg hover:-translate-y-1">
          ...
          <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 flex items-center space-x-4 border-t-4 border-cyan-500 transition-all hover:shadow-lg hover:-translate-y-1">
      ...
      <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-4 border-t-4 border-indigo-500">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 border-t-4 border-green-500">
                  <h3 class="text-2xl font-semibold text-gray-700 dark:text-white">Student Statistics</h3>
              ...
              <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 border-t-4 border-green-500">
                  <h3 class="text-2xl font-semibold text-gray-700 dark:text-white mb-3">Enrollment Trends</h3>
