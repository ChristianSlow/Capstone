<template>
    <main class="p-4 md:ml-64 h-auto pt-14 bg-red-800">
        <h1 class="text-center p-4 text-white text-5xl font-bold">COURSES AND SUBJECTS</h1>
...
import { ProductService } from '../../service/ProductServicecourse';
