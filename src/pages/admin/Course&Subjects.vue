    ...
    <div>
        <div class="card">
            <Toolbar class="mb-6">
                ...
                <template #center>
                    <h4 class="m-0 font-bold text-4xl">COURSES</h4>
                </template>
                <template #end>
            ...
            >
                ...
                <Column field="major" header="Major" style="min-width: 16rem"></Column>  
        ...
        <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Add Course" :modal="true">
            <div class="flex flex-col gap-6">
                ...
                <div>
                    ...
                    <InputText id="course" v-model.trim="product.course" required="true" autofocus :invalid="submitted && !product.course" fluid />
                    <small v-if="submitted && !product.course" class="text-red-500">Course is required.</small>
                </div>
                <div>
                    <label for="major" class="block font-bold mb-3">Major</label>
                    <InputText id="major" v-model.trim="product.major" required="true" autofocus :invalid="submitted && !product.major" fluid />
                    <small v-if="submitted && !product.major" class="text-red-500">Major is required.</small>
                </div>
                <!-- <div>
