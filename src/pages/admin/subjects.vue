            ...
            >
                <template #header>
                    <div class="flex flex-wrap gap-2 items-center justify-between">
                        <h4 class="m-0">Manage Subjects</h4>
                        <IconField>
                            <InputIcon>
                ...
                <Column field="schedule" header="Schedule" style="min-width: 12rem"></Column>
                <Column field="Instructor" header="Instructor" style="min-width: 16rem"></Column>
                <Column field="Average" header="Average" style="min-width: 10rem"></Column>
