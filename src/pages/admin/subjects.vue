    ...
    <div class="bg-white dark:bg-gray-800 shadow-md p-4 mb-4">
      <div class="grid md:grid-cols-2 gap-6">
        <div>
          ...
          <select v-model="selectedCourse" class="w-full mt-1 p-3 border rounded-lg focus:ring-1 focus:ring-black bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600">
        ...
        <div v-if="selectedCourse">
          ...
          <select v-model="selectedMajor" class="w-full mt-1 p-3 border rounded-lg focus:ring-1 focus:ring-black bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600">
