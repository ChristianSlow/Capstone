        ...
        <div class="flex-1 flex flex-col items-center">
            ...
            <div class="flex justify-center flex-1 flex-col">
                <form class="max-w-sm mx-auto w-72">
                    ...
                    <button type="submit" class="text-white bg-red-800 hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                </form> 
            </div>
